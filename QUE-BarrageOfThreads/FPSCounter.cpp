...
void FPSCounter::initialize()
{
	...
	this->statsText->setPosition(BaseRunner::WINDOW_WIDTH - 150, BaseRunner::WINDOW_HEIGHT - 100);
...
void FPSCounter::updateFPS(sf::Time elapsedTime)
{
	...
	if (this->updateTime >= sf::seconds(0.25f))
	{
		...
		this->statsText->setString("FPS: " + std::to_string(static_cast<int>(BaseRunner::getInstance()->getFPS())) + "\n");
	}
}
